...
int main(int argc, char const *argv[]) { 
    ...
    double z = -dJ; 
    double raioDaEsf = 40.0;

    double cJan[3] = {0.0,0.0,-dJ}; 
    double centroEsfera[3] = {0.0,0.0,-100}; 
    double P_o[3] = {0.0,0.0,0.0}; 
    double Fonte_luminosa[3] = {0.0,60.0,-30.0}; 
    double I_f[3] = {0.7,0.7,0.7}; 
    double L_amb[3] = {0.3,0.3,0.3};
    double K_d_esfera[3] = {0.7,0.2,0.2}; 
    double K_e_esfera[3] = {0.7,0.2,0.2}; 
    double w[3] = { 
    ...
    /* Planos */
    /* PLano chão */
    double P_pi_chao[3] = {0.0,-raioDaEsf, 0.0};
    double N_bar_chao[3] = {0.0,1,0.0};
    double K_d_plano_chao[3] = {0.2,0.7,0.2};
    double K_e_plano_chao[3] = {0.0,0.0,0.0};
    double K_a_plano_chao[3] = {0.2,0.7,0.2};

    /* PLano fundo */
    double P_pi_fundo[3] = {0.0,0.0,-200};
    double N_bar_fundo[3] = {0.0,0.0,1.0};
    double K_d_plano_fundo[3] = {0.3,0.3,0.7};
    double K_e_plano_fundo[3] = {0.0,0.0,0.0};
    double K_a_plano_fundo[3] = {0.3,0.3,0.7};  
    ...
    for (int l = 0; l < n_linhas; l++) { 
        ...
        for (int c = 0; c < n_colunas; c++) { 
            ...
            if (delta > 0) { 
                ...
                double I_eye_d[3] = { 
                    I_f[0] * K_d_esfera[0]*F_d, 
                    I_f[1] * K_d_esfera[1]*F_d, 
                    I_f[2] * K_d_esfera[2]*F_d 
                };
                ...
                double I_eye_e[3] = { 
                    I_f[0] * K_e_esfera[0]*F_e, 
                    I_f[1] * K_e_esfera[1]*F_e, 
                    I_f[2] * K_e_esfera[2]*F_e 
                };
            ...
            /* calculo T_i do plano chão */
            double W_x_N = prod_Esc(w,N_bar_chao);
            /* double Dr_x_N = prod_Esc(dir, N_bar_chao);
            double T_i_plano_chao = -W_x_N/Dr_x_N; */
            if (W_x_N > 0) {
                printf("%lf\n", W_x_N);
            }
