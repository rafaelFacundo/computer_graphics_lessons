...
class Vector {
    ...
    public:
        ...
        void shearYX(double angle);
        void shearXY(double angle);
        void shearXZ(double angle);
        void shearZX(double angle);
        void shearYZ(double angle);
        void shearZY(double angle);
